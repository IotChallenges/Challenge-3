...
The non uniform performance indicates that some nodes suffer from poor link quality due to distance or obstacles. Moving nodes closer to the gateway improves signal strength and reliability.Increasing the spreading factor would increase airtime and collision probability, while decreasing the number of nodes does not solve the uneven performance across nodes.
